...
const staticProjects = [
  ...
  },
  {
    ...
    category: "Web Development",
    description:
      "Responsive portfolio, business, landing page, and WordPress website work for students, individuals, and small businesses.",
  ...
  {
    id: "uiux-design",
    title: "UI/UX & Creative Design Work",
    category: "UI/UX Design",
    description:
      "Interface layouts, social media creatives, AI posters, and visual design work for personal branding and digital promotion.",
    technologies: ["Figma", "Canva", "AI Tools", "Branding"],
    github_url: null,
    live_url: null,
    linkedin_url: null,
    behance_url: null,
  ...
  {
    id: "academic-tech",
    title: "Academic & Technology Concepts",
    category: "Academic Projects",
    description:
      "Student-focused project ideas and prototypes across IoT, AI chatbots, MERN stack systems, Firebase dashboards, and smart automation.",
    technologies: ["AI", "IoT", "MERN", "Firebase", "Unity"],
    github_url: null,
    live_url: null,
    linkedin_url: null,
    behance_url: null,
...
const staticCertificates = [
  ...
  },
  {
    ...
    verification_link: null,
    certificate_image: null,
    provider_logo: "/logos/london-met.png",
    skills: ["Software Engineering", "Software Development", "Project Development"],
    featured: true,
    display_order: 2,
  },
];
